module.exports.initialize = function(universe) {
	 ...
	 * @param {Object} event.message.sent The timestamp at which the event was sent by the UI (By the User's time)
	 * @param {Object} event.message.data Typical location of data from the UI
	 * @param {String} event.message.data.entity Object ID
	 * @param {Integer} event.message.data.slot
	 */
	universe.on("player:spell:slot", function(event) {
		console.log("Spell: ", event.message.data);
		var entity = event.message.data.entity,
		...
		if(entity && typeof(slot) === "number" && universe.hasAccess(event.player, entity)) {
			entity.setValues({
				"cast_level": slot
			});
		}
